    ...
    useEffect(()=>{
        ...
        const draw=()=>{
            ...
            for(let i=0;i<drops.length;i++){
                ...
                if(drops[i]*15>canvas.height&& Math.random()>0.89){
                    drops[i]=0;
                }
                drops[i]+=1;      
            }
	...
	<div className="main">
	    ...
	    <div className="hero" id="hero">                
                <div class="vortex">
                    ...
                    <div class="circle2 center rotate3"></div>
                    <div class="halfcircle center rotation"></div>
                    <div class="halfcircle2 center rotation rotate3"></div>
                    <div class="circle3 center rotation"></div>
                    <div class="circle4 center rotation"></div>
                    <div class="circle5 center rotate3"></div>
		...
		<div className="description blink">
		    ...
		    <p className="whoami-output type-animation">I'm Siddhant.<br/>Interested in Robotics, Mechatronics, Software and Space Technology.</p>
		    <p className="cat-aboutme type-animation">~ $ cat about-me.txt</p>
		    <p className="aboutme">
			I am a multidisciplinary learner with expertise in Mechatronics, Robotics and programming, driven by
		...
		<center><h2 class="type-animation">Skills</h2></center>
		...
		<div className="project-blocks">
		    ...
		    <div class="project-border" style={{animationDelay:'1s'}}>
                        <div class="project">
			    <ScanFace size='45px' class=""/>
			    <h3 class="title"><a href="https://github.com/DEV-SDHNT/Facial-Expressions-Recognition">
                                              Expression Recognizer</a></h3>
			    <div class="tools-block">
		    ...
		    <div class="project-border" style={{animationDelay:'2s'}}>
                        <div class="project">
			    <ChartNoAxesCombined size='45px' class=""/>
			    <h3 class="title">
		    ...
		    <div class="project-border" style={{animationDelay:'3s'}}>
                        <div class="project">
			    <MessagesSquare size='45px' class=""/>
			    <h3 class="title">
			    ...
			    <div class="tools-block">
                    ...
                    <div class="project-border" style={{animationDelay:'3s'}}>
                        <div class="project">
			    <ArrowUp10 size='45px' class=""/>
			    <h3 class="title">
                                <a href="https://youtu.be/3gDmSU8DFbw?si=jdBQTy-gQuFfHxDM">Sorting Visualizer</a>
                            </h3>
			    <div class="tools-block">
			        <span class="tool zoomer" style={{animationDelay:'0s'}}>C++</span>
			        <span class="tool zoomer" style={{animationDelay:'0.2s'}}>Raylib</span>
			    </div>
		        </div>
                    </div>
		</div>
